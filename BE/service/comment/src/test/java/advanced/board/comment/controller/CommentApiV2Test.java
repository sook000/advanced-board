...
public class CommentApiV2Test {
    ...
    void create() {
         ...
         * response1.getCommentId() = 210658226118643712
         * 	response2.getPath() = 0000000000
         * 	response2.getCommentId() = 210658227423072256
         * 		response3.getPath() = 000000000000000
         * 		response3.getCommentId() = 210658227506958336
         */
    }
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v2/comments/{commentId}", 210658226118643712L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void readAll() {
        ...
        /**
         * comment.getCommentId() = 210659782666715391
         * comment.getCommentId() = 210659782666715392
         * comment.getCommentId() = 210659782666715393
         * comment.getCommentId() = 210659782666715394
         * comment.getCommentId() = 210659782666715395
         * comment.getCommentId() = 210659782666715396
         * comment.getCommentId() = 210659782666715397
         * comment.getCommentId() = 210659782666715398
         * comment.getCommentId() = 210659782666715399
         * comment.getCommentId() = 210659782666715400
         */
    }
